...
public class ExtractTest {
    ...
    private static final Tweet tweet1 = new Tweet(1, "alyssa", " @fatima is it reasonable to talk about rivest so much?", d1);
    private static final Tweet tweet2 = new Tweet(2, "bbitdiddle", "rivest talk in 30 minutes #hype", d2);
    private static final Tweet tweet3 = new Tweet(3, "fatima", "junit tests in #software_construction", d2);
